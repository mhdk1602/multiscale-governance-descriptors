...
\begin{enumerate}
  ...
  \item \textbf{A reproduction of a published centrality result at node
        ...
        same corpus: the top predictors are PageRank and out-degree. Phase
...
dimension could characterize a governance signal in data
...
LR $t=9.12$, $p=0.0003$; RF $t=9.18$, $p=0.0003$.}
\end{tabular}
\end{table}
...
exact before/after dbt manifests, post-merge repairs adjudicated within
...
(ii) an inference protocol for governance--topology studies
...
graph-aggregate governance pilot within one organisation, with an explicit
...
\citet{chen2023centrality} on the Huawei Cloud DLGs, reported as a
reproduction rather than a governance result for the descriptors. The
Phase 5 model does not test D1--D4 incremental value. Governance maturity is better measured
